...
const ChatRoomReadModeContext = createContext<ChatRoomReadModeContextType | undefined>(undefined)

// Provider 컴포넌트
export const ChatRoomReadModeProvider = ({ children }: { children: React.ReactNode }) => {
...
export const useChatRoomReadMode = () => {
  ...
  if (!context) {
    throw new Error("useChatRoomReadMode는 반드시 ChatRoomReadModeProvider 안에서 사용해야 합니다.")
  }
  return context
}